...
# Form implementation generated from reading ui file 'gui_V10.ui'
#
...
class Ui_SAXS_TOOLBOX(object):
    def setupUi(self, SAXS_TOOLBOX):
        ...
        self.menuModelisation = QtWidgets.QMenu(self.menubar)
        self.menuModelisation.setObjectName("menuModelisation")
        ...
        self.menuModelisation.addAction(self.actionCompute_I_q_from_pdb_file)
        ...
        self.menubar.addAction(self.menuModelisation.menuAction())
    ...
    def retranslateUi(self, SAXS_TOOLBOX):
        ...
        self.menuModelisation.setTitle(_translate("SAXS_TOOLBOX", "Modelisation"))
...
class ApplicationWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Modelisation
        self.ui.actionCompute_I_q_from_pdb_file.triggered.connect(self.run_sasview)
        return
    ...
    def batch_regroup_plot(self):
        ...
        if a==1:
            ...
            for file in filenames:
                ...
                self.number_pixel_y = int(header[self.ui.key_dim2_lineEdit.text()])            
                output=self.path+'/'+os.path.basename(file).split('.')[0]+"_radial_profile.dat"
                self.ui.console_textEdit.insertPlainText("1D data filed created: %s \n"%output)
                nbins=1000
                unit_type="q_nm^-1"
                detector = pyFAI.detectors.Detector(pixel1=self.pix_size, pixel2=self.pix_size)
                ai = AzimuthalIntegrator(dist=self.distance, detector=detector) 
    ...
    def caving(self):
        if a==1:
            ...
            try:
                ...
                self.ui.console_textEdit.insertPlainText('An error occured, did you specify maskfile?\n')
        else:
